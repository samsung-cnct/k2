podTemplate(label: 'k2', containers: [
    ...
    containerTemplate(name: 'k2-tools', image: 'quay.io/coffeepac/k2-tools:appr-removed', ttyEnabled: true, command: 'cat', alwaysPullImage: true, resourceRequestMemory: '1Gi', resourceLimitMemory: '1Gi'),
