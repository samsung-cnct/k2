podTemplate(label: 'k2', containers: [
    ...
    containerTemplate(name: 'k2-tools', image: 'quay.io/nathanzsamsung/k2-tools-test:52.1', ttyEnabled: true, command: 'cat', alwaysPullImage: true, resourceRequestMemory: '1Gi', resourceLimitMemory: '1Gi'),
